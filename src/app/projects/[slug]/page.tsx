...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  const externalAction = project.href.startsWith("http");
    ...
    <Container>
      <article className="pb-10">
        ...
        {project.metrics && project.metrics.length > 0 && (
          <dl className="mt-10 grid gap-px overflow-hidden rounded-[24px] border border-slate-200 bg-slate-200 sm:grid-cols-3">
